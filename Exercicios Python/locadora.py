...
print("======")
print("Bem vindo à locadorda de carros")
print("======")
...
while True:
    ...
    print("O - Mostrar portifólio | 1 - Alugar um carro | 2 - Devolver um carro")
    op = int(input())
    ...
    if op == 0:
        ...
        print("Você escolheu {} por {}".format(carros[cod_car][0], dias))
